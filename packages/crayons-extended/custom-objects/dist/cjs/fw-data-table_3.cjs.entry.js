...
const Translation$1 = require('./Translation-95805542.js');
...
const SortSelect = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.fwSort = index.createEvent(this, "fwSort", 7);
    this.sortOrderData = [
      { value: 'ASC', text: Translation$1.TranslationController.t('sortSelect.ascending') },
      { value: 'DESC', text: Translation$1.TranslationController.t('sortSelect.descending') },
    ];
    /**
  ...
  render() {
    return (index.h("fw-popover", { ref: (sortDropdown) => (this.sortDropdown = sortDropdown), class: 'sort', "same-width": 'false', placement: 'bottom-start', trigger: 'manual' }, index.h("div", { class: 'sort-container', slot: 'popover-trigger' }, index.h("div", { class: 'sort-action', tabIndex: 0, role: 'button', onClick: (e) => {
        this.toggleDropdown(e);
      }, onKeyDown: utils.handleKeyDown(this.toggleDropdown.bind(this)) }, index.h("span", null, this.sortColumnName), index.h("span", { class: {
        'dropdown-status-icon': true,
        'expanded': this.isExpanded,
      } }, index.h("fw-icon", { name: 'chevron-down', color: '#264966', size: 8, library: 'system' })))), index.h("div", { slot: 'popover-content' }, index.h("fw-list-options", { id: 'sortBy', allowDeselect: false, value: this.orderBy, options: this.sortOptions }, ' '), index.h("hr", { class: 'divider' }), index.h("span", { class: 'order-label' }, Translation$1.TranslationController.t('platformTable.orderby')), index.h("fw-list-options", { id: 'sortOrder', allowDeselect: false, value: this.order, options: this.sortOrderData }))));
  }
  static get watchers() { return {
    "orderBy": ["onDefaultSortChange"]
  }; }
};
SortSelect.style = sortSelectCss;

exports.fw_data_table = DataTable;
exports.fw_pagination = Pagination;
exports.fw_sort_select = SortSelect;
