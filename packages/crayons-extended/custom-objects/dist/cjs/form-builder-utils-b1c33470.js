...
function i18nText(strKey, context = {}) {
  try {
    if (strKey && context) {
      return Translation.TranslationController.t(`formBuilder.${strKey}`, context);
    }
    else if (strKey) {
      return Translation.TranslationController.t(`formBuilder.${strKey}`);
    }
  }
  catch (error) {
...
exports.buildChoicesFromText = buildChoicesFromText;
exports.checkIfCustomToggleField = checkIfCustomToggleField;
exports.createUUID = createUUID;
exports.deepCloneObject = deepCloneObject;
exports.deleteChoicesInFields = deleteChoicesInFields;
exports.deriveInternalNameFromLabel = deriveInternalNameFromLabel;
exports.formMapper = formMapper;
exports.getChildChoices = getChildChoices;
exports.getDefaultDependentLevels = getDefaultDependentLevels;
exports.getDependentLevels = getDependentLevels;
exports.getFieldTypeCheckboxes = getFieldTypeCheckboxes;
exports.getMappedCustomFieldType = getMappedCustomFieldType;
exports.getMaxLimitProperty = getMaxLimitProperty;
exports.getMaximumLimitsConfig = getMaximumLimitsConfig;
exports.getNestedKeyValueFromObject = getNestedKeyValueFromObject;
exports.hasCustomProperty = hasCustomProperty;
exports.hasDuplicates = hasDuplicates;
exports.hasPermission = hasPermission;
exports.i18nText = i18nText;
exports.isPrimaryFieldType = isPrimaryFieldType;
exports.isUniqueField = isUniqueField;
exports.removeFirstOccurrence = removeFirstOccurrence;
exports.updateChoicesInFields = updateChoicesInFields;
exports.updateFieldAttributes = updateFieldAttributes;
exports.updateLevelSelection = updateLevelSelection;
