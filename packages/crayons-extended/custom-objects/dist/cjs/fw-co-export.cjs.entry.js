...
const CoExport = class {
  constructor(hostRef) {
    ...
    this.fwExport = index.createEvent(this, "fwExport", 7);
    this.fwCloseExport = index.createEvent(this, "fwCloseExport", 7);
    ...
    this.exportHandler = (event) => {
      event.stopImmediatePropagation();
      event.stopPropagation();
      this.fwExport.emit({ value: formBuilderUtils.deepCloneObject(this.value) });
    };
  ...
  renderCheckboxField(dataField) {
    const strKey = this.searching && this.searchText && this.searchText !== ''
      ...
      : `${dataField.id}`;
    return (index.h("fw-co-export-field", { key: strKey, value: dataField, onFwChange: this.fieldSelectionChangeHandler }));
  }
  render() {
    var _a, _b, _c;
    ...
    const strFilteredData = boolShowFilteredRecords
      ? Translation.TranslationController.t('export.filterInfo', {
    ...
    return (index.h("fw-modal", { isOpen: this.isOpen, slider: true, icon: 'download', titleText: Translation.TranslationController.t('export.modalTitle'), onFwClose: this.closeModalHandler }, index.h("fw-modal-content", { class: 'co-export-modal-content' }, index.h("div", { class: strBaseClassName }, boolShowFilteredRecords && (index.h("fw-inline-message", { open: true, type: 'info', closable: false }, index.h("span", { innerHTML: strFilteredData }))), index.h("div", { class: 'co-export-format' }, index.h("span", { class: 'co-export-format-label' }, Translation.TranslationController.t('export.exportFormat')), arrExportFormat && arrExportFormat.length > 0 && (index.h("fw-radio-group", { orientation: 'row', value: strSelectedFormatValue, onFwChange: this.exportFormatChangeHandler }, arrExportFormat.map((dataItem) => {
      return (index.h("fw-radio", { value: dataItem.value }, dataItem.label));
    })))), index.h("div", { class: 'co-export-field-selection' }, index.h("div", { class: 'co-export-field-header' }, index.h("span", { class: 'co-export-field-header-label' }, Translation.TranslationController.t('export.fields')), index.h("span", { class: 'co-export-field-header-selected-count-label' }, Translation.TranslationController.t('export.selectedFields', {
      count: this.selectedFieldCount,
    }))), index.h("div", { class: 'co-export-field-content' }, index.h("div", { class: 'co-export-field-content-header' }, index.h("fw-checkbox", { class: 'co-export-field-select-all', checked: this.allFieldsSelected, onFwChange: this.selectAllFieldsChangeHandler }, index.h("span", { class: `co-export-field-select-all-label` }, Translation.TranslationController.t('export.selectAllFields'))), boolShowSearch && (index.h("fw-input", { "clear-input": true, "icon-left": 'search', placeholder: Translation.TranslationController.t('export.searchFieldsPrompt'), onFwInput: this.debouncedHandleInput, onFwInputClear: this.clearSearchHandler, class: 'co-export-field-search' }))), index.h("div", { class: 'co-export-field-content-fields' }, !boolShowEmptySearch && (index.h("div", { class: strFirstColumnClassName }, fieldColumn1Elements)), !boolShowEmptySearch && boolShowSecondColumn && (index.h("div", { class: 'co-export-field-content-fields-column2' }, fieldColumn2Elements)), boolShowEmptySearch && (index.h("span", { class: `co-export-field-empty-search-message` }, Translation.TranslationController.t('export.noSearchResults')))))))), index.h("fw-modal-footer", null, index.h("span", { class: 'co-export-modal-footer' }, index.h("fw-button", { color: 'secondary', onFwClick: this.closeModalHandler }, Translation.TranslationController.t('export.cancelButton')), index.h("fw-button", { onFwClick: this.exportHandler }, Translation.TranslationController.t('export.submitButton'))))));
  }
  get host() { return index.getElement(this); }
};
CoExport.style = coExportCss;

exports.fw_co_export = CoExport;
