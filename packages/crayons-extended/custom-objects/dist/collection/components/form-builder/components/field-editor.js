...
import { deepCloneObject, hasCustomProperty, getNestedKeyValueFromObject, i18nText, removeFirstOccurrence, getMaxLimitProperty, getMaximumLimitsConfig, deriveInternalNameFromLabel, hasPermission, checkIfCustomToggleField, hasDuplicates, getChildChoices, updateLevelSelection, buildChoicesFromText, getDependentLevels, updateFieldAttributes, updateChoicesInFields, deleteChoicesInFields, } from '../utils/form-builder-utils';
...
export class FieldEditor {
  ...
  renderCheckboxField(dataCheckbox) {
    ...
    return (h("div", { class: `${strBaseClassName}-content-checkbox-container` },
      h("fw-checkbox", { class: `${strBaseClassName}-content-fw-checkbox`, ref: (el) => (this.dictInteractiveElements[strKey] = el), key: strKey, value: strKey, disabled: boolDisableCheckbox, checked: dataCheckbox.selected, onFwChange: this.checkboxSelectionChangeHandler }, i18nText(dataCheckbox.display_label)),
      boolShowInfo && (h("fw-tooltip", { placement: 'right', trigger: 'hover', content: strLimitMessage },
        h("fw-icon", { class: `${strBaseClassName}-content-fw-icon`, size: 14, name: 'info', color: '#264966' })))));
  }
  ...
  renderStatusToggle(objFormValue) {
    ...
    return (h("div", { class: `${strBaseClassName}-status-toggle` },
      h("div", { class: `${strBaseClassName}-status-toggle-item header` },
        h("span", null, i18nText('fieldLabel')),
        h("span", null, i18nText('ertText'))),
      choices.map((dataItem) => {
        ...
        if ((dataItem === null || dataItem === void 0 ? void 0 : dataItem.choice_options) &&
          ...
          toggle = (h("span", null,
            h("fw-toggle", { id: dataItem.id, size: 'medium', checked: dataItem === null || dataItem === void 0 ? void 0 : dataItem.choice_options.resolution_timer, onFwChange: this.statusToggleHandler })));
        }
        return (h("div", { class: `${strBaseClassName}-status-toggle-item` },
          h("span", null,
            h("div", { class: `${strBaseClassName}-input-container` },
              h("fw-input", { class: `${strBaseClassName}-content-required-input`, value: dataItem.value, disabled: 'true' }))),
          toggle));
      })));
  }
  ...
  renderInternalName(objProductConfig, objMaxLimits, isDefaultNonCustomField, boolEditAllowed, fieldBuilderOptions) {
    ...
    return (h("div", { class: `${strBaseClassName}-internal-name-base` },
      h("label", { class: `${strBaseClassName}-internal-name-header-label required` }, i18nText('internalName')),
      h("div", { class: `${strBaseClassName}-internal-name-container` },
        !isDefaultNonCustomField && (h("label", { class: `${strBaseClassName}-internal-name-prefix` }, this.internalNamePrefix)),
  ...
  renderFieldContent(objProductConfig, isDefaultNonCustomField, boolEditAllowed) {
    ...
    return (h("div", { class: `${strBaseClassName}-content` },
      h("div", { class: `${strBaseClassName}-content-required` },
        h("div", { class: `${strBaseClassName}-content-checkboxes` },
          h("label", { class: `${strBaseClassName}-content-checkboxes-header-label` }, i18nText('behaviour')),
          checkboxItems),
        h("div", null,
          h("label", { class: `${strBaseClassName}-content-label` }, i18nText('labels')),
          h("div", { class: 'flex flex-space-between' }, renderLabelAndName.map((field) => field))),
        h("div", null,
          h("label", { class: `${strBaseClassName}-content-label` }, i18nText('dropdownChoices')),
          this.showDependentFieldTextbox ? (h("div", null,
            h("label", { class: `${strBaseClassName}-content-dependent-label` }, i18nText('dependentDropdownMessage')),
            h("span", { class: `${strBaseClassName}-textbox` },
              h("textarea", { rows: 8, value: this.textboxDependentValue, onKeyDown: this.handleDependentField })),
            h("fw-button", { size: 'small', color: 'secondary', onFwClick: this.switchToDropdownView }, i18nText('addChoices')))) : (h("div", { class: 'flex flex-space-between' }, renderFields.map((field) => field)))))));
  }
  renderLabelAndInternalName(objProductConfig, isDefaultNonCustomField, boolEditAllowed, fieldBuilderOptions) {
    ...
    const boolSupportInternalName = objProductConfig.editInternalName;
    const strBaseClassName = 'fw-field-editor';
    return (h("div", { class: `${strBaseClassName}-content-label-interalName` },
      this.renderLabel(objMaxLimits, isDefaultNonCustomField, boolEditAllowed, fieldBuilderOptions),
    ...
    return (h("div", { class: `${strBaseClassName}-content` },
      h("div", { class: `${strBaseClassName}-content-required` },
        h("div", { class: `${strBaseClassName}-content-checkboxes` },
          h("label", { class: `${strBaseClassName}-content-checkboxes-header-label` }, i18nText('behaviour')),
          checkboxItems),
        isLookupType && (h("div", { class: `${strBaseClassName}-content-lookup` }, elementRelationship)),
        this.renderLabel(objMaxLimits, isDefaultNonCustomField, boolEditAllowed, this.fieldBuilderOptions),
        boolSupportInternalName &&
          this.renderInternalName(objProductConfig, objMaxLimits, isDefaultNonCustomField, boolEditAllowed, this.fieldBuilderOptions),
        elementStatusToggle,
        isDropdownType && (h("div", { class: `${strBaseClassName}-content-dropdown` }, elementDropdown)))));
  }
  render() {
    ...
    return (h(Host, { tabIndex: '-1' },
      h("div", { class: strComponentClassName, ref: (el) => (this.divFieldBase = el), onDragEnd: this.stopParentDragging, onDrop: this.stopParentDragging },
        h("div", { class: `${strBaseClassName}-header` },
          h("div", { role: 'none', class: `${strBaseClassName}-drag-container`, onMouseDown: this.startParentDragging },
            h("fw-icon", { size: 14, name: 'drag', color: '#CFD7DF' })),
          h("div", { class: `${strBaseClassName}-header-content`, onClick: this.expandHandler },
            h("span", { class: `${strBaseClassName}-icon-container`, style: { backgroundColor: fieldIcon.bg_color } },
              h("fw-icon", { size: 14, name: fieldIcon.name, color: '#475867' })),
            h("label", { class: `${strBaseClassName}-label` }, strHeaderLabel),
            !this.expanded && (h("div", { class: `${strBaseClassName}-key-fw-labels` }, fwLabelItems))),
          !this.expanded &&
            !this.isPrimaryField &&
            !this.isDeleting &&
            !isDefaultNonCustomField && (h("fw-button", { part: 'delete-field-btn', size: 'icon', color: 'secondary', disabled: boolDisableDelete, class: `${strBaseClassName}-delete-button`, onFwClick: this.deleteFieldClickHandler },
            h("fw-icon", { name: 'delete' }))),
          !this.expanded && !this.isPrimaryField && this.isDeleting && (h("fw-spinner", { class: `${strBaseClassName}-deleting-state`, size: 'medium', color: '#d72d30' }))),
        this.expanded && (h("div", { class: `${strBaseClassName}-body` },
          contentElements,
          h("div", { class: strFooterClassName },
            boolShowFieldValidationError && (h("span", { class: `${strBaseClassName}-footer-field-error-container` },
              h("fw-icon", { size: 12, name: 'warning', color: '#d72d30' }),
              h("label", { class: `${strBaseClassName}-footer-field-error-msg` }, this.formErrorMessage))),
            h("span", { class: `${strBaseClassName}-footer-buttons-container` },
              boolShowCancelBtn && (h("fw-button", { id: 'clearFieldBtn', color: 'secondary', onFwClick: this.cancelFieldHandler }, i18nText('cancelFieldBtn'))),
              h("fw-button", { id: 'submitFieldBtn', color: 'primary', loading: this.isLoading, disabled: !boolEnableSaveBtn, onFwClick: this.addFieldHandler }, strSaveBtnLabel)))))),
      h("fw-modal", { ref: (el) => (this.modalConfirmDelete = el), icon: 'delete', submitColor: 'danger', hasCloseIconButton: false, titleText: strDeleteModalTitleText, submitText: i18nText('deleteFieldSubmit'), onFwSubmit: this.confirmDeleteFieldHandler },
        h("span", { class: 'fw-field-editor-delete-modal-content' },
          boolShowDeleteModalInlineMsg && (h("fw-inline-message", { open: true, type: 'warning' }, strDeleteModalInlineMessage)),
          strDeleteModalMessage))));
  }
  static get is() { return "fw-field-editor"; }
  ...
  static get properties() { return {
    ...
    "expanded": {
      ...
      "docs": {
        "tags": [],
        "text": "Property to determine expanded state or collapsed"
      },
      "attribute": "expanded",
      "reflect": false,
      "defaultValue": "false"
    ...
    "disabledSort": {
      ...
      "docs": {
        "tags": [],
        "text": "Disable the repositioning option"
      },
      "attribute": "disabled-sort",
      "reflect": false,
      "defaultValue": "false"
    },
    "entityName": {
      ...
      "docs": {
        "tags": [],
        "text": "defines the name of the entity to be used in Lookup field"
      },
      "attribute": "entity-name",
      "reflect": false,
      "defaultValue": "''"
    },
    "defaultFieldTypeSchema": {
      "type": "any",
      "mutable": false,
      "complexType": {
        "original": "any",
      ...
      "docs": {
        "tags": [],
        "text": "stores the default field type schema for this editor type"
      },
      "attribute": "default-field-type-schema",
      "reflect": false
    },
    "isPrimaryField": {
      "type": "boolean",
    ...
    "enableFilterable": {
      ...
      "docs": {
        "tags": [],
        "text": "Flag to enable / disable the the filterable option"
      },
      "attribute": "enable-filterable",
      "reflect": false,
      "defaultValue": "true"
    },
    "enableUnique": {
      ...
      "docs": {
        "tags": [],
        "text": "Flag to enable / disable the the unique option"
      },
      "attribute": "enable-unique",
      "reflect": false,
      "defaultValue": "true"
    },
    "index": {
    ...
    "role": {
      ...
      "docs": {
        "tags": [],
        "text": "Disable features for the users with free trial plan"
      },
      "attribute": "role",
      "reflect": false,
      "defaultValue": "'admin'"
  ...
  static get events() { return [{
      ...
      "docs": {
        "tags": [],
        "text": "Triggered when the field details need to be saved on the server"
      },
      "complexType": {
        "original": "any",
        "resolved": "any",
      ...
      "docs": {
        "tags": [],
        "text": "Triggered when the field has to be deleted on the server"
      },
      "complexType": {
        "original": "any",
        "resolved": "any",
      ...
      "docs": {
        "tags": [],
        "text": "Triggered when the field is reordered for drag start and drag stop"
      },
      "complexType": {
        "original": "any",
        "resolved": "any",
  ...
  static get watchers() { return [{
      "propName": "enableUnique",
      "methodName": "watchEnableUniqueChangeHandler"
    }, {
      "propName": "enableFilterable",
      "methodName": "watchEnableFilterableChangeHandler"
    }, {
      "propName": "dataProvider",
      "methodName": "watchDataproviderChangeHandler"
    }]; }
}
