...
import { i as i18nText, d as deepCloneObject, f as hasCustomProperty, n as getNestedKeyValueFromObject, o as hasDuplicates, r as removeFirstOccurrence, u as updateFieldAttributes, p as checkIfCustomToggleField, h as hasPermission, q as updateLevelSelection, s as updateChoicesInFields, t as deleteChoicesInFields, v as buildChoicesFromText, w as deriveInternalNameFromLabel, x as getDependentLevels, m as getMaxLimitProperty, y as getChildChoices, b as getMaximumLimitsConfig, k as formMapper } from './form-builder-utils.js';
import { p as presetSchema, d as defineCustomElement$h } from './fb-field-lookup.js';
import { d as defineCustomElement$n } from './avatar.js';
import { d as defineCustomElement$m } from './button.js';
import { d as defineCustomElement$l } from './checkbox.js';
import { d as defineCustomElement$k } from './drag-container.js';
import { d as defineCustomElement$j } from './fb-field-dropdown.js';
import { d as defineCustomElement$i } from './fb-field-dropdown-item.js';
...
import { d as defineCustomElement$b } from './modal.js';
import { d as defineCustomElement$a } from './modal-content.js';
import { d as defineCustomElement$9 } from './modal-footer.js';
import { d as defineCustomElement$8 } from './modal-title.js';
...
const FieldEditor = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return fieldEditorCss; }
}, [1, "fw-field-editor", {
    ...
    "lookupTargetObjects": [1028, "lookup-target-objects"],
    "disabledSort": [4, "disabled-sort"],
    "entityName": [1, "entity-name"],
    "defaultFieldTypeSchema": [8, "default-field-type-schema"],
    "isPrimaryField": [4, "is-primary-field"],
    "enableFilterable": [4, "enable-filterable"],
    "enableUnique": [4, "enable-unique"],
    "index": [2],
    "name": [1],
    "role": [1],
    "permission": [16],
    "isValuesChanged": [32],
    "fieldBuilderOptions": [32],
    "showErrors": [32],
    "duplicateErrors": [32],
    "formErrorMessage": [32],
    "labelErrorMessage": [32],
    "labelWarningMessage": [32],
    "internalNameErrorMessage": [32],
    "internalNameWarningMessage": [32],
    "isDeleting": [32],
    "dependentLevels": [32],
    "showDependentFieldTextbox": [32]
  }]);
function defineCustomElement() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["fw-field-editor", "fw-avatar", "fw-button", "fw-checkbox", "fw-drag-container", "fw-fb-field-dropdown", "fw-fb-field-dropdown-item", "fw-fb-field-lookup", "fw-icon", "fw-inline-message", "fw-input", "fw-label", "fw-list-options", "fw-modal", "fw-modal-content", "fw-modal-footer", "fw-modal-title", "fw-popover", "fw-select", "fw-select-option", "fw-spinner", "fw-tag", "fw-toggle", "fw-tooltip"];
  components.forEach(tagName => { switch (tagName) {
    case "fw-field-editor":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, FieldEditor);
      }
      break;
    case "fw-avatar":
      if (!customElements.get(tagName)) {
...
export { FieldEditor as F, defineCustomElement as d };
