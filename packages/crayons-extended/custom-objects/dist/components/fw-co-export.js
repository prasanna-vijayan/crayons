...
import { d as deepCloneObject } from './form-builder-utils.js';
import { d as defineCustomElement$g } from './button.js';
import { d as defineCustomElement$f } from './checkbox.js';
import { d as defineCustomElement$e } from './co-export-field.js';
import { d as defineCustomElement$d } from './icon.js';
import { d as defineCustomElement$c } from './inline-message.js';
import { d as defineCustomElement$b } from './input.js';
import { d as defineCustomElement$a } from './modal.js';
import { d as defineCustomElement$9 } from './modal-content.js';
import { d as defineCustomElement$8 } from './modal-footer.js';
import { d as defineCustomElement$7 } from './modal-title.js';
...
const CoExport = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return coExportCss; }
}, [1, "fw-co-export", {
    "isOpen": [1540, "is-open"],
    "value": [1032],
    "allFieldsSelected": [32],
    "arrSearchedFields": [32],
    "searching": [32],
    "searchText": [32],
    "clearFilter": [32],
    "selectedFieldCount": [32],
    "close": [64],
    "open": [64]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["fw-co-export", "fw-button", "fw-checkbox", "fw-co-export-field", "fw-icon", "fw-inline-message", "fw-input", "fw-modal", "fw-modal-content", "fw-modal-footer", "fw-modal-title", "fw-popover", "fw-radio", "fw-radio-group", "fw-spinner", "fw-tooltip"];
  components.forEach(tagName => { switch (tagName) {
    case "fw-co-export":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CoExport);
      }
      break;
    case "fw-button":
      if (!customElements.get(tagName)) {
...
const FwCoExport = CoExport;
const defineCustomElement = defineCustomElement$1;

export { FwCoExport, defineCustomElement };
