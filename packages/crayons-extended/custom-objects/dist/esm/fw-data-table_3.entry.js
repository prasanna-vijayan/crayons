import { r as registerInstance, c as createEvent, h, g as getElement, i as Host } from './index-f435cf58.js';
import { T as TranslationController } from './Translation-1d30aa87.js';
import { p as popperModifierRTL } from './index-1063dee9.js';
import { c as createPopper } from './popper-5ea645b1.js';
import { T as TranslationController$1 } from './Translation-7ee0e3b3.js';
...
const SortSelect = class {
  constructor(hostRef) {
    ...
    this.sortOrderData = [
      { value: 'ASC', text: TranslationController$1.t('sortSelect.ascending') },
      { value: 'DESC', text: TranslationController$1.t('sortSelect.descending') },
    ];
    /**
  ...
  render() {
    return (h("fw-popover", { ref: (sortDropdown) => (this.sortDropdown = sortDropdown), class: 'sort', "same-width": 'false', placement: 'bottom-start', trigger: 'manual' }, h("div", { class: 'sort-container', slot: 'popover-trigger' }, h("div", { class: 'sort-action', tabIndex: 0, role: 'button', onClick: (e) => {
      ...
      } }, h("fw-icon", { name: 'chevron-down', color: '#264966', size: 8, library: 'system' })))), h("div", { slot: 'popover-content' }, h("fw-list-options", { id: 'sortBy', allowDeselect: false, value: this.orderBy, options: this.sortOptions }, ' '), h("hr", { class: 'divider' }), h("span", { class: 'order-label' }, TranslationController$1.t('platformTable.orderby')), h("fw-list-options", { id: 'sortOrder', allowDeselect: false, value: this.order, options: this.sortOrderData }))));
  }
  static get watchers() { return {
...
export { DataTable as fw_data_table, Pagination as fw_pagination, SortSelect as fw_sort_select };
