...
const index$2 = require('./index-926a762d.js');
const index$1 = require('./index-e79e09fe.js');
...
const FileUploader = class {
  ...
  fileValidation(file) {
    ...
    if (this.maxFileSize !== 0) {
      if (fileSize > this.maxFileSize * index$1.MB_TO_KB * index$1.KB_TO_BYTE) {
        isPassed = false;
  ...
  render() {
    ...
    index$2.renderHiddenField(this.host, this.name, null, this._getFiles());
